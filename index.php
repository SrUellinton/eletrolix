...
if (isset($_POST['btn-entrar'])) :
    ...
    if (empty($login) && empty($senha)) :
      ...
      Verifique os campos de email e senha, e preencha-os, é possivel que estejam vazios!
        ...
        $sql = "SELECT id,type_user, email FROM users WHERE email = '$login' AND type_user='Master'";
        ...
        Usuário $login, não possui acesso a area de administração Eletrolix®!
    </div>";
    ...
    <div id="loading">
        <div class="loader simple-loader">
            <div class="loader-body">
                <img src="assets/images/favicon.png" alt="loader" class="light-loader img-fluid w-25" width="200" height="200">
            </div>
        </div>
    </div>
    <!-- loader END -->
    <div class="wrapper">
        <div class="iq-auth-page">
            ...
            <div class="row d-flex align-items-center iq-auth-container w-100">
                <div class="col-12 col-xl-12 offset-xl-4 offset-1">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                        ...
                                        <h3 class="text-center"><img src="assets/images/logo.png" height="230" alt=""></h3>
