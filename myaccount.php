...
<head>
    ...
    <title>Meu perfil - Eletrolix</title>
...
<body class="  ">
                ...
                <ul class="navbar-nav iq-main-menu" id="iq-filemanger-page">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="pontoscoleta.php">
                            ...
                            <div>
                                <span class="badge bg-warning d-inline-block rounded-pill">
                                    <?php
    ...
    <main class="main-content">
        <div class="position-relative  iq-banner ">
            ...
            </nav> <!--Nav End--> <!-- Nav Header Component Start -->
                                    ...
                                    <div class="iq-timeline0 m-0 d-flex align-items-center justify-content-between position-relative">
                                        <ul class="list-inline p-0 m-0">
                                            ...
                                            if ($result_act  == null || $result_act  == "") {
                                                echo '<li>
                                                <h6 class="float-left mb-3"><img src="assets/images/nada_encontrado.png" class="img-fluid" alt=""></h6>
                                                <h4 class="float-left mb-1">Nenhuma atividade registrada no sistema</h4>
