...
<head>
    ...
    <title> Pontos de coileta - Eletrolix </title>
...
<body class="">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex justify-content-end">
                                    <button class='btn btn-primary ' data-bs-toggle="modal" data-bs-target="#cadastroEcoponto">Cadastrar novo ponto</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped mb-0" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Fazem retirada local?</th>
                                    ...
                                    <tbody>
                                        ...
                                        $query_cli = mysqli_query($connect, "SELECT*FROM collection_points");
                                        while ($dados_cli = mysqli_fetch_array($query_cli)) :

                                        ?>
                                            <tr>
                                                <td>
                                                    <h5><?= $dados_cli['place_name'] ?></a></h5>
                                                    <p class="mb-0"></p>
                                                </td>
                                                <td class="text-dark"><?= $dados_cli['opening_hours'] ?></td>
                                                <td class="text-dark"><?= $dados_cli['type_of_collection'] ?></td>
                                                <td class="text-dark"><?= $dados_cli['we_make_withdrawal'] ?></td>
                                                <td class="text-dark"><?= $dados_cli['created_at'] ?></td>
                                                <td>
                                                    <div class="d-flex justify-content-evenly gap-1">
                                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="client_details.php?idclient=<?= $dados_cli['id'] ?>" role="button">
                                                            <span class="btn-inner">
                                                                <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <a class="btn btn-danger btn-icon btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#excluirPonto<?= $dados_cli['id'] ?>" role="button">
                                                            <span class="btn-inner">
                                                                <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path opacity="0.4" d="M19.643 9.48851C19.643 9.5565 19.11 16.2973 18.8056 19.1342C18.615 20.8751 17.4927 21.9311 15.8092 21.9611C14.5157 21.9901 13.2494 22.0001 12.0036 22.0001C10.6809 22.0001 9.38741 21.9901 8.13185 21.9611C6.50477 21.9221 5.38147 20.8451 5.20057 19.1342C4.88741 16.2873 4.36418 9.5565 4.35445 9.48851C4.34473 9.28351 4.41086 9.08852 4.54507 8.93053C4.67734 8.78453 4.86796 8.69653 5.06831 8.69653H18.9388C19.1382 8.69653 19.3191 8.78453 19.4621 8.93053C19.5953 9.08852 19.6624 9.28351 19.643 9.48851Z" fill="currentColor"></path>
                                                                    <path d="M21 5.97686C21 5.56588 20.6761 5.24389 20.2871 5.24389H17.3714C16.7781 5.24389 16.2627 4.8219 16.1304 4.22692L15.967 3.49795C15.7385 2.61698 14.9498 2 14.0647 2H9.93624C9.0415 2 8.26054 2.61698 8.02323 3.54595L7.87054 4.22792C7.7373 4.8219 7.22185 5.24389 6.62957 5.24389H3.71385C3.32386 5.24389 3 5.56588 3 5.97686V6.35685C3 6.75783 3.32386 7.08982 3.71385 7.08982H20.2871C20.6761 7.08982 21 6.75783 21 6.35685V5.97686Z" fill="currentColor"></path>
                                            ...
                                            <div class="modal fade" id="excluirPonto<?= $dados_cli['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-danger">
                                                            <h5 class="modal-title text-white" id="staticBackdropLabel">Exclusão do cliente <?= $dados_cli['place_name'] ?></h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="model/excluir_ponto.php" method="post" autocomplete="off">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="hidden" class="form-control mb-0" name="point_id" value="<?= $dados_cli['id'] ?>" placeholder="Enter email" autocomplete="off">
                                                                </div>
    ...
    <!---- modal de cadastro de ecoponto -->

    <div class='modal modal-lg fade' id='cadastroEcoponto' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header bg-primary' style='border:none;'>
                    <h5 class='modal-title text-white' id='staticBackdropLabel'>Cadastro novo</h5>
                    <button type='button' class='btn-close rounded-circle bg-danger' data-bs-dismiss='modal' aria-label='Close'></button>
                </div>
                <div class='modal-body'>
                    <form action='model/cadastrar_ponto.php' method='post'>
                        <div class='row '>
                            <div class='col-lg-6'>
                            <input type='hidden' class='form-control' id='place_name' name='user_id' value="<?php echo $dados['id']?>" autocomplete='off' required>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Nome do local</label>
                                    <input type='text' class='form-control' id='place_name' name='place_name' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Horário de funcionamento</label>
                                    <input type='time' class='form-control' id='opening_hours' name='opening_hours' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Dias de funcionamento</label>
                                    <input type='text' class='form-control' id='day_of_operation' name='day_of_operation' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Tipo de coleta</label>
                                    <input type='text' class='form-control' id='type_of_collection' name='type_of_collection' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Fazemos retirada</label>
                                    <select class="form-select" name="we_make_withdrawal" aria-label="Default select example">
                            ...
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Rua</label>
                                    <input type='text' class='form-control' id='tstreet' name='street' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Bairro</label>
                                    <input type='text' class='form-control' id='district' name='district' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Cidade</label>
                                    <input type='text' class='form-control' id='city' name='city' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Estado</label>
                                    <input type='text' class='form-control' id='state' name='state' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Numero + completmento</label>
                                    <input type='text' class='form-control' id='number' name='number' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Latitude</label>
                                    <input type='text' class='form-control' id='latitude' name='latitude' autocomplete='off' required>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Longitude</label>
                                    <input type='text' class='form-control' id='longitude' name='longitude' autocomplete='off' required>
                                </div>
                            </div>
