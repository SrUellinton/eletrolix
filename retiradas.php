...
<head>
    ...
    <title> Pontos de coleta - Eletrolix </title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Solicitações de retirada</h4>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped mb-0" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Email do solicitante</th>
                                            <th scope="col">Endereço do mesmo</th>
                                            <th scope="col">Tipo de material</th>
                                            <th scope="col">Melhor horario para retirada</th>
                                    ...
                                    <tbody>
                                        ...
                                        $query_cli = mysqli_query($connect, "SELECT*FROM withdrawals");
                                        while ($dados_cli = mysqli_fetch_array($query_cli)) :

                                        ?>
                                            <tr>
                                                <td>
                                                    <h5><?= $dados_cli['name_of_the_applicant'] ?></a></h5>
                                                    <p class="mb-0"></p>
                                                </td>
                                                <td class="text-dark"><?= $dados_cli['applicants_email'] ?></td>
                                                <td class="text-dark"><?= $dados_cli['we_make_withdrawal'], "Nº ".$dados_cli['number'],  $dados_cli['district'], $dados_cli['city'] ?></td>
                                                <td class="text-dark"><?= $dados_cli['type_of_collection'] ?></td>
                                                <td class="text-dark"><?= $dados_cli['pick_up_time'] ?></td>
